 ...
 */ const checkDenoiserSupport = (assetsPath)=>{
    if (!window.__denoiser) {
        ...
        const external = new __WEBPACK_EXTERNAL_MODULE_agora_extension_ai_denoiser__.AIDenoiserExtension({
...
class PcmAudioProcessor extends __WEBPACK_EXTERNAL_MODULE_agora_rte_extension__.AudioProcessor {
    async onNode(node, context) {
        const audioContext = context.getAudioContext();
...
class PcmRecorder {
    async start() {
        ...
        if (mediaStreamTrack) this.audioTrack = await (0, __WEBPACK_EXTERNAL_MODULE_agora_rtc_sdk_ng_esm__.createCustomAudioTrack)({
            mediaStreamTrack
        });
        else {
...
export { pcm_recorder_AIDenoiserProcessorLevel as AIDenoiserProcessorLevel, pcm_recorder_AIDenoiserProcessorMode as AIDenoiserProcessorMode, pcm_recorder as PcmRecorder, ws_tools_chat as WsChatClient, types_WsChatEventNames as WsChatEventNames, speech as WsSpeechClient, utils_namespaceObject as WsToolsUtils, transcription as WsTranscriptionClient };
